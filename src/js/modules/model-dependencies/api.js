async function fetchColors(hexOrRgbString, type, mode, resultsNum) {
    try {
        ...
        let modeChoice = "monochrome"; // all mode choices: monochrome, monochrome-dark, monochrome-light, analogic, complement, analogic-complement, triad, quad
        ...
        if (!response.ok) throw new Error("Fetching from thecolorapi.com was unsuccessful");
